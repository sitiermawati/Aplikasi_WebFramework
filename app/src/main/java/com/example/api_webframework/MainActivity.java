...
public class MainActivity extends AppCompatActivity {
    ...
    void setupListview () {
        ...
        AdapterFramework adapter = new AdapterFramework(this, dataFrameworks);
    ...
    private AdapterView.OnItemClickListener onItemClick = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            DataFramework fSELECTED = dataFrameworks.get(position);
            Intent intent = new Intent(MainActivity.this, DetailFramework.class);
    ...
    void refreshView() {
        ...
        while(key.hasNext()) {
            ...
            try {
                ...
                dataFrameworks.add(new DataFramework(nameFramework, author, official_web, des, img));
